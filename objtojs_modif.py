...
def convertFile(path):
    ...
    for line in arrayLines :
        ...
        if arrayLine[0] == 'usemtl':
            materialList.update({materialName:{k:f}})
            k = k + 1
            f = []
    ...
    for newMaterial in materialList:
     materialName = newMaterial
     f = []
     for tab in materialList[newMaterial]:
      f.append(materialList[newMaterial][tab])
     f = f[0]
     for t in f:
     ...
     newpath = path[0:len(path)-4] +"_"+materialName+ ".js"
